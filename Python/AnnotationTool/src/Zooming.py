...
class Example(tk.Frame):
    def __init__(self, root):
        ...
        #self.canvas.bind('<Button-4>', lambda event : self.canvas.xview('scroll', -1, 'units'))
        #self.canvas.bind('<Button-5>', lambda event : self.canvas.xview('scroll', 1, 'units'))
        #self.canvas.bind("<Button-2>", self.self.zoomer)
        #linux scroll
